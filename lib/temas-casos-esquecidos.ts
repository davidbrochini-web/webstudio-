...
export const TEMAS: Record<string, Tema> = {
  'lendas-urbanas': {
    ...
    titleSeo: 'Contos de Terror de Lendas Urbanas', // ≤60 c/ template ' | Casos Esquecidos'
  ...
  'terror-psicologico': {
    ...
    titleSeo: 'Contos de Terror Psicológico',
  ...
  'sobrenatural': {
    ...
    titleSeo: 'Contos Sobrenaturais e Paranormais',
  ...
  'criaturas': {
    ...
    nomeCurto: 'Criaturas',
    titleSeo: 'Contos de Terror com Criaturas',
  ...
  'terror-tecnologico': {
    ...
    titleSeo: 'Contos de Terror da Internet',
  ...
  'maldicoes': {
    ...
    nomeCurto: 'Maldições',
    titleSeo: 'Contos de Terror sobre Maldições',
  ...
  'assombracao': {
    ...
    titleSeo: 'Histórias de Assombração',
