const features = [
  ...
  },
  {
    ...
    desc: 'Você posta no Instagram como sempre faz — em minutos, o mesmo post aparece no seu site também, sem precisar fazer nada a mais.',
  },
  {
    icon: '🔒',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map(({ icon, title, desc }) => (
            <div
              key={title}
              className="p-7 border border-[var(--border)] rounded-2xl hover:border-green-200 hover:shadow-lg hover:shadow-green-50 transition-all"
            >
