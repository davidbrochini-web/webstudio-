  ...
  return (
    <div className="animate-float w-[148px] flex-shrink-0 bg-[#18182a] rounded-[24px] p-1.5 shadow-[0_28px_56px_rgba(0,0,0,.30),0_0_0_1px_rgba(255,255,255,.06)]">
      <div className="bg-white rounded-[19px] overflow-hidden">
        ...
        {/* Post image */}
        <div className="w-full aspect-square bg-gradient-to-br from-[#667eea] to-[#764ba2] flex items-center justify-center text-2xl">
          🍕
        </div>
        {/* Footer */}
        <div className="px-2.5 py-2">
          ...
          <p className="text-[8px] text-gray-500 mt-0.5 leading-tight">
            Novidade no cardápio! Vem conhecer 🔥
          </p>
        </div>
      </div>
    </div>
...
function SyncDots() {
  return (
    <div className="flex flex-col items-center gap-2 flex-shrink-0">
      <span className="text-[8px] font-bold text-[var(--purple)] bg-purple-50 px-2 py-0.5 rounded-full whitespace-nowrap">
        automático
      </span>
  ...
  return (
    <div className="animate-float-delay w-[200px] flex-shrink-0 bg-white border border-[var(--border)] rounded-xl overflow-hidden shadow-[0_28px_56px_rgba(124,58,237,.1)]">
      ...
      <div className="bg-[var(--off)] px-2.5 py-1.5 flex items-center gap-1.5 border-b border-[var(--border)]">
        <div className="flex gap-1">
          {[0,1,2].map(i => <div key={i} className="w-1.5 h-1.5 rounded-full bg-[var(--border)]" />)}
        </div>
        <div className="flex-1 bg-white border border-[var(--border)] rounded px-1.5 py-0.5 text-[7px] text-[var(--muted)]">
          meunegocio.com.br
        </div>
      </div>
      {/* Site content */}
      <div className="p-2">
        <div className="flex items-center justify-between pb-2 mb-2 border-b border-[var(--border)]">
          ...
          <div className="flex gap-1.5">
            <span className="text-[7px] text-[var(--muted)]">Menu</span>
            <span className="text-[7px] text-[var(--muted)]">Contato</span>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-0.5">
          <div className="aspect-square rounded-[3px] bg-gradient-to-br from-[#667eea] to-[#764ba2] animate-pop relative">
            <span className="absolute top-0.5 right-0.5 text-[6px] text-white/80">✦</span>
          </div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <div className="inline-flex items-center gap-2 text-xs font-semibold text-[var(--purple)] bg-purple-50 px-4 py-1.5 rounded-full mb-5">
            ...
            Site integrado ao Instagram
          </div>

          <h1 className="font-display font-extrabold text-[clamp(32px,8vw,58px)] leading-[1.08] text-[var(--dark)] mb-5">
            Postou no Instagram,<br />
            <span className="grad-text">atualizou o site.</span>
          </h1>

          <p className="text-base lg:text-lg text-[var(--muted)] leading-relaxed mb-8 max-w-[480px] mx-auto lg:mx-0">
            Criamos sites profissionais para o seu negócio que se atualizam
            automaticamente com o seu feed do Instagram. Você continua postando
            normalmente — o site cuida de si mesmo.
          </p>
