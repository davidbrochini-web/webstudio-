...
import { inscreverNewsletter, type ContatoFormState } from '@/app/projetos-especiais/colegio-elite/actions'
  ...
  return (
    <form action={formAction} className="flex flex-col gap-2">
      ...
      <button
        type="submit"
        disabled={pending}
        className="bg-[var(--ce-primary)] text-white text-sm font-bold px-4 py-2 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-60"
      >
