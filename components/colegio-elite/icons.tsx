...
// dentista-joao, sem depender de nenhuma lib de ícone nova.
...
export function IconMetro({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className}>
      <rect x="4" y="3" width="16" height="14" rx="4" />
      <path strokeLinecap="round" d="M8 21l2-4h4l2 4M4 12h16" />
