  ...
  return (
    <>
      <button
        ...
        className="flex-shrink-0 text-xs font-medium text-[var(--muted)] hover:text-[var(--ink)] border border-[var(--border)] hover:border-[var(--brand)] rounded-full px-3 py-1.5 transition-colors whitespace-nowrap"
      >
