...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: `Tratamentos — ${site.business_name}`, robots: { index: site.status === 'publicado' } }
}
  ...
  return (
    <PageShell site={site}>
      <section className="px-6 py-16 max-w-5xl mx-auto">
        <h1 className="font-display font-extrabold text-3xl text-[#0B2B3C] mb-10">Tratamentos</h1>
        {!tratamentos?.length ? (
